...
- **Firma en la nube (Cl@ve Firma)**: firma electrónica con **certificados centralizados** custodiados en servidores remotos de la Administración. La identificación y firma electrónica se desarrollan en el tema 61.
...
- **Definición**: sistema de gestión de **documentos y expedientes electrónicos conforme al ENI**: garantiza que unos y otros se almacenan e intercambian según las NTI de documento y expediente electrónico (ver temas 51 y 58), como gestión documental «viva» previa al archivo definitivo.
