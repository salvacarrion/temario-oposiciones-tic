...
- **ISO/IEC 38500** (*Governance of IT for the organization*; **3.ª edición, 2024**): norma dirigida al órgano de gobierno. Se articula en tres herramientas: los **principios**, el **modelo** y el **marco** de gobernanza de la TI. El modelo asigna al órgano de gobierno tres tareas cíclicas: **evaluar** el uso actual y futuro de la TI, **dirigir** mediante estrategias y políticas, y **supervisar** (*monitor*) el cumplimiento y el rendimiento. Las ediciones anteriores (2008 y 2015) enunciaban **6 principios** clásicos: responsabilidad, estrategia, adquisición, rendimiento, conformidad y comportamiento humano; la edición de 2024 los reformula y amplía en línea con la ISO 37000 de gobernanza de organizaciones (propósito, generación de valor, estrategia, supervisión, rendición de cuentas, implicación de las partes interesadas, liderazgo, datos y decisiones, gobernanza del riesgo, responsabilidad social y viabilidad y rendimiento a largo plazo).
...
- **Actividades del proceso** (Métrica v3): **PSI 1** Inicio del plan de sistemas de información; **PSI 2** Definición y organización del PSI; **PSI 3** Estudio de la información relevante (planes estratégicos, normativa); **PSI 4** Identificación de requisitos; **PSI 5** Estudio de los sistemas de información actuales (diagnóstico de la situación, DAFO); **PSI 6** Diseño del modelo de sistemas de información; **PSI 7** Definición de la arquitectura tecnológica; **PSI 8** Definición del plan de acción; y **PSI 9** Revisión y aprobación del PSI.
...
- **Indicadores**: cada objetivo se mide con **KPI** (indicadores clave de rendimiento) con meta y responsable; deben ser **SMART** (específicos, medibles, alcanzables, relevantes y acotados en el tiempo). Se combinan indicadores de resultado (*lag*) e inductores (*lead*). En la gestión pública se distinguen además indicadores de **economía** (coste de los recursos), **eficacia** (grado de consecución de los objetivos) y **eficiencia** (relación entre resultados y recursos empleados), las «3 E».
...
- **Alternativas de sourcing**: desarrollo a medida (propio o contratado), producto comercial (COTS) parametrizado, software libre, **reutilización** de soluciones de otras Administraciones y servicios en la nube (SaaS, ver temas [22](22-contratacion-publica-de-bienes-y-servicios-tic.md) y [51](51-computacion-en-la-nube-y-altas-prestaciones.md)). Antes de adquirir o desarrollar, las AAPP **deben consultar el directorio general de aplicaciones** y, si existe una solución reutilizable total o parcialmente, están **obligadas a su uso**, salvo que justifiquen lo contrario en términos de eficiencia (arts. 157 y 158 de la Ley 40/2015, ver tema [50](50-proteccion-juridica-del-software-y-licencias.md)).
...
- **Modelo EFQM** (edición **2025**): modelo europeo de excelencia en gestión. Se estructura en **tres bloques**: **Dirección** (por qué y cómo se orienta la organización), **Ejecución** (cómo entrega valor) y **Resultados** (qué consigue), desarrollados en **7 criterios** y **28 subcriterios**; la evaluación aplica la lógica **RADAR** (Resultados, Enfoques, Despliegue, Evaluación y Revisión), simplificada en la edición 2025 a dos matrices de evaluación (una para Dirección y Ejecución y otra para Resultados), y da acceso a los sellos de reconocimiento.
...
- **Real Decreto 951/2005** (texto consolidado a **30 de junio de 2009**): establece el **marco general para la mejora de la calidad** en la AGE, integrado por **6 programas**: análisis de la demanda y evaluación de la satisfacción de los usuarios; **cartas de servicios**; quejas y sugerencias; evaluación de la calidad de las organizaciones; reconocimiento; y Observatorio de la Calidad de los Servicios Públicos. La evaluación de la calidad se articula en **dos niveles** (autoevaluación y evaluación externa, art. 20) conforme a modelos de gestión de calidad reconocidos (entre ellos EFQM, CAF y el modelo **EVAM**, Evaluación, Aprendizaje y Mejora, diseñado para la AGE); el programa de reconocimiento comprende **dos subprogramas** (art. 22): el reconocimiento a la excelencia (certificación y concesión de un sello) y los **premios a la calidad e innovación en la gestión pública**.
- **Cartas de servicios** (arts. 8 a 13): documentos por los que cada órgano informa sobre los servicios que presta, los **derechos** de los usuarios, los **compromisos de calidad** (plazos de tramitación, horarios y canales de atención, indicadores) y las **medidas de subsanación** en caso de incumplimiento, cuyo reconocimiento corresponde al titular del órgano y que en ningún caso dan lugar a **responsabilidad patrimonial**. Existen también **cartas de servicios electrónicos** (art. 13) y la norma **UNE 93200** especifica sus requisitos.
...
- **Agencia Estatal de Administración Digital (AEAD)**: sucede a la Secretaría General de Administración Digital como brazo ejecutor TIC de la AGE; su Estatuto se aprobó por el **Real Decreto 1118/2024**, de 5 de noviembre, y se constituyó el **21 de febrero de 2025**. Presta los servicios comunes y compartidos de administración digital (ver tema [63](63-infraestructuras-y-servicios-comunes-de-interoperabilidad.md)). Tras la reorganización del **Real Decreto 466/2026**, de 10 de junio (que escindió en dos la antigua dirección de ciberseguridad), se estructura en **cuatro direcciones** (Administración Digital; Prestación de Infraestructuras y Operaciones; **Ciberseguridad**; y Tecnologías Disruptivas e Integridad de los Datos) más una Secretaría General.
...
- Métrica versión 3, documentos «Introducción» y proceso «Planificación de Sistemas de Información» (Ministerio de Administraciones Públicas, PAe).
...
- Real Decreto 1118/2024 (Estatuto de la AEAD; texto consolidado, última modificación 12 de junio de 2026, por el Real Decreto 466/2026) y Real Decreto 1125/2024 (organización de la Administración Digital del Estado, sin modificaciones), BOE, contrastados online en julio de 2026.
