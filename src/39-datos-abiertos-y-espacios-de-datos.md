...
- **Tarifas** (art. 7): la reutilización es **gratuita** como regla general; solo cabe repercutir los **costes marginales** de reproducción, puesta a disposición, difusión, anonimización de datos personales y protección de la información comercial confidencial, con excepciones tasadas (organismos obligados a autofinanciarse, bibliotecas, museos y archivos, y sociedades mercantiles públicas, que pueden añadir un margen razonable). Los datos de alto valor y los de investigación son siempre gratuitos, con excepciones transitorias muy limitadas.
- **Condiciones generales** (art. 8): la reutilización puede someterse, entre otras, a que el contenido y sus metadatos **no sean alterados**, que **no se desnaturalice el sentido** de la información, que se **cite la fuente** y que se mencione la **fecha de la última actualización**.
- **Procedimiento previa solicitud** (art. 10): la solicitud se dirige al órgano en cuyo poder obran los documentos (si no los posee, remite la solicitud al que los tenga o se lo indica al solicitante); si es imprecisa, se requiere concreción en **10 días**, con suspensión del plazo para resolver. Resolución en el plazo máximo de **20 días**, ampliable **otros 20** cuando el volumen o la complejidad lo impidan (informando de la ampliación en 10 días); el **silencio es desestimatorio**. No están obligadas a este procedimiento las sociedades mercantiles públicas, los centros de enseñanza ni las organizaciones que realizan o financian investigación.
- **Unidad responsable de información** (art. 10 bis): cada entidad determina la unidad que garantiza la puesta a disposición de su información (en la AGE, en el ámbito de las **Subsecretarías** de cada departamento). Funciones: coordinar la reutilización con las políticas de publicaciones y administración electrónica, informar de los órganos competentes para las solicitudes, promover formatos adecuados y actualizados, y fomentar la promoción, concienciación y formación.
- **Régimen sancionador** (art. 11, ámbito AGE): infracciones **muy graves** (desnaturalizar el sentido de la información con licencia, alteración muy grave del contenido), **graves** (reutilizar sin la licencia exigida, usar la información para una finalidad distinta de la concedida, alteración grave) y **leves** (no citar la fuente, no mencionar la fecha de última actualización, alteración leve). Multas de **50.001 a 100.000 euros** (muy graves), de **10.001 a 50.000** (graves) y de **1.000 a 10.000** (leves); en las graves y muy graves cabe además la **prohibición de reutilizar de 1 a 5 años** y la revocación de la licencia.
...
- **Conjuntos de datos de alto valor**: el **Reglamento de Ejecución (UE) 2023/138** (aplicable desde el **9 de junio de 2024**) establece la lista europea en **seis categorías temáticas**: **geoespacial; observación de la Tierra y medio ambiente; meteorología; estadísticas; sociedades y propiedad de sociedades; y movilidad**. Deben publicarse gratuitamente, en formato legible por máquina, mediante **API** y descarga masiva cuando proceda, con las condiciones de la dedicación al dominio público **CC0** o, alternativamente, de la licencia **Creative Commons BY 4.0** (o equivalente o menos restrictiva) y metadatos conformes a DCAT-AP; los Estados presentan a la Comisión un informe de aplicación a los **dos años** de la entrada en vigor y lo actualizan **cada dos años** a petición de la Comisión.
...
- **Reglamento (UE) 2022/868, de gobernanza de datos (Data Governance Act, DGA)**, aplicable desde el **24 de septiembre de 2023**. Cuatro pilares:
  ...
  - **Servicios de intermediación de datos**: prestadores que conectan a titulares y usuarios de datos bajo un régimen de **notificación previa** y **neutralidad** (no pueden usar los datos intercambiados para fines propios y deben prestar el servicio a través de una **persona jurídica distinta**), con la denominación «proveedor de servicios de intermediación de datos reconocido en la Unión», logotipo común y registro público de la Comisión.
...
- **Reglamento (UE) 2023/2854, de datos (Data Act)**, en vigor desde el 11 de enero de 2024 y **aplicable desde el 12 de septiembre de 2025**. Contenidos principales:
  ...
  - **Cambio entre servicios de tratamiento de datos** (nube): derecho a cambiar de proveedor con plazos y asistencia, eliminación progresiva de los costes de cambio (**suprimidos desde el 12 de enero de 2027**) y requisitos de interoperabilidad (contra el *lock-in*, ver temas [22](22-contratacion-publica-de-bienes-y-servicios-tic.md) y [51](51-computacion-en-la-nube-y-altas-prestaciones.md)).
...
- **Espacios de datos sectoriales europeos**: la Comisión impulsa **espacios comunes europeos de datos** en sectores estratégicos: salud (el EEDS, primer espacio regulado por reglamento, ver tema [94](94-historia-clinica-digital-hcdsns-myhealth-eu-eeds.md)), movilidad, energía, agricultura, administraciones públicas, Pacto Verde, industria o competencias, con el middleware **Simpl** y un centro de soporte (*Data Spaces Support Centre*). En España los impulsa la SEDIA (Oficina del Dato) con fondos del Plan de Recuperación.
