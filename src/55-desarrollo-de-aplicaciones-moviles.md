...
- **Tipografía y color**: tipografías sans-serif legibles en pantalla y un sistema cromático consistente y con significado (rojo para errores, verde para confirmaciones), respetando el contraste (accesibilidad, tema 54).
...
El diseño adaptativo y la accesibilidad se tratan en el tema 54; las tecnologías web subyacentes, en el 53.
