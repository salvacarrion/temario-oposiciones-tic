...
- **Par trenzado**: cuatro pares de hilos de cobre trenzados (el trenzado cancela interferencias y diafonía), impedancia característica de **100 ohmios**, conector **RJ45** y alcance de canal de **100 m**. Según el apantallamiento se denomina **U/UTP** (sin pantalla), **F/UTP** (pantalla global de lámina) o **S/FTP** (malla global y lámina por par); en la nomenclatura **X/YTP**, la primera letra indica la pantalla global del cable y la segunda la de cada par. Es el medio estándar del cableado horizontal por su coste y facilidad de instalación.

| Categoría | Ancho de banda | Aplicación típica |
| --- | --- | --- |
| **3** | 16 MHz | Telefonía y 10BASE-T (legado) |
...
- **IEEE 802.3bz-2016** (*NBASE-T*): define **2.5GBASE-T sobre categoría 5e** y **5GBASE-T sobre categoría 6**, ambos hasta 100 m, para reaprovechar el cableado ya instalado (el caso típico son los AP Wi-Fi 6) manteniendo la compatibilidad con PoE.
- Las categorías **7/7A** apenas se desplegaron: exigen conectores propios distintos del RJ45 (**GG45, TERA**) y la 6A ya cubre 10 Gbps; en la práctica se salta de la 6A a la 8, y esta solo en el CPD.
- **Cable coaxial**: conductor central y malla concéntrica, gran inmunidad al ruido. Fue el medio del Ethernet original de **50 ohmios** (10BASE5 «grueso» y 10BASE2 «fino» con conectores BNC, en topología de bus); hoy es residual en redes de datos y pervive en las redes de televisión por cable **CATV/HFC** (**75 ohmios**, tema [74](74-redes-de-transporte-voz-y-audiovisuales.md)) y en radiofrecuencia (antenas).
- **Fibra óptica**: transmite pulsos de luz por un núcleo de vidrio que los confina por reflexión total interna; inmune a interferencias electromagnéticas, sin emisiones (más segura frente a escuchas) y con atenuaciones muy bajas (del orden de **0,2 a 0,4 dB/km**), lo que da alcances y anchos de banda muy superiores al cobre. Se transmite en las **ventanas** de menor atenuación: **850 nm** (multimodo), **1310 y 1550 nm** (monomodo). Dos tipos:
  - **Monomodo**: núcleo de **9 µm**, láser a 1310/1550 nm, alcances de kilómetros; es la fibra de los enlaces troncales, el acceso FTTH y las redes de operador. **OS1** es la especificación de interior (cable ajustado, hasta **1 dB/km**) y **OS2** la de exterior en tubo holgado (**0,4 dB/km**), la habitual en troncales y campus.
  - **Multimodo (OM1 a OM5)**: núcleo de **50 µm** (62,5 µm en la antigua OM1), fuentes VCSEL a 850 nm, alcances de cientos de metros: **OM3** (10 Gbps hasta 300 m), **OM4** (10 Gbps hasta 550 m), **OM5** (multiplexación por longitud de onda corta, SWDM). Con óptica paralela SR4, 40/100 Gbps alcanzan **100 m en OM3** y **150 m en OM4**. Habitual dentro del edificio y el CPD.
  - **Conectores**: **LC** (pequeño factor de forma, el habitual), SC, ST (bayoneta, legado) y MPO/MTP para enlaces paralelos de alta densidad. Por el pulido de la férula: **UPC** (recto, azul en monomodo) y **APC** (verde, corte en ángulo de **8°** con mejor pérdida de retorno, el obligado en FTTH/GPON); no son conectables entre sí.
...
Las dos normas de referencia definen el mismo modelo: **ANSI/TIA-568** (familia norteamericana: **568.0** cableado genérico, **568.1** edificios comerciales, **568.2** par trenzado y **568.3** fibra; revisión vigente del par trenzado: **ANSI/TIA-568.2-E, de octubre de 2024**) e **ISO/IEC 11801** (internacional; su equivalente europeo es la serie **EN 50173**). La serie ISO/IEC 11801 se organiza por entornos: **-1** requisitos generales (edición vigente **2017**), **-2** oficinas, **-3** industrial, **-4** viviendas, **-5** centros de datos y **-6** servicios de edificio distribuidos. La topología es una **estrella jerárquica**: cada toma llega a un repartidor de planta, y los repartidores se interconectan por el troncal.
...
- **Subsistema horizontal**: desde el repartidor de planta hasta la toma de usuario: máximo **90 m** de enlace permanente más **10 m** de latiguillos (canal de **100 m**). No debe haber empalmes ni derivaciones; solo se admite un único **punto de consolidación (CP)**, una interconexión pasiva intermedia útil en oficinas abiertas para reconfigurar puestos sin recablear (la variante **MUTOA** agrupa las tomas de varios usuarios en un punto multiusuario).
- **Área de trabajo**: la toma de telecomunicaciones (TO) y los latiguillos del puesto; se recomienda un mínimo de **dos tomas por puesto** de trabajo.

En la terminología ISO los repartidores se llaman distribuidores: **CD** (*campus distributor*, repartidor de campus), **BD** (*building distributor*, repartidor de edificio) y **FD** (*floor distributor*, repartidor de planta). Como referencia de diseño siguen usándose las distancias troncales orientativas de las ediciones clásicas de TIA-568: **800 m** en cobre multipar (solo voz), **2000 m** en fibra multimodo y **3000 m** en monomodo; el horizontal es siempre de **90 + 10 m**, sea cual sea el medio.
...
- **Mapa de hilos y longitud**: continuidad, orden de los pares (esquemas **T568A/T568B**, que solo intercambian los pares naranja y verde; el B es el más extendido, y no deben mezclarse en una misma instalación) y longitud máxima.
...
En la UE, el cable instalado de forma permanente en un edificio es producto de construcción: debe llevar marcado CE con una **euroclase de reacción al fuego** conforme al reglamento **CPR (Reglamento UE 305/2011)**, obligatorio para cables desde el **1 de julio de 2017**. Las euroclases van de mejor a peor comportamiento: **Aca, B1ca, B2ca, Cca, Dca, Eca y Fca**, con criterios adicionales de opacidad de humos (**s**), gotas incandescentes (**d**) y acidez (**a**), ensayadas según **EN 50575**. El pliego fija la euroclase exigida según el uso del edificio, y es práctica habitual la cubierta **LSZH** (libre de halógenos y baja emisión de humos) en interior.

## El cableado del CPD y PoE

El centro de proceso de datos tiene su propia norma de infraestructura (**ANSI/TIA-942**, tratada en el tema [43](43-centros-de-proceso-de-datos.md); en el mundo ISO/CENELEC, **ISO/IEC 11801-5** y **EN 50173-5**) que aplica el modelo estructurado a las áreas del CPD (distribuidor principal MDA, distribuidores horizontales HDA y áreas de equipos EDA), con topologías de conmutación **ToR** (*top of rack*, conmutador en cada armario) o **EoR** (*end of row*). En CPD la práctica actual es **categoría 6A como mínimo** en cobre y fibra **OM4/OS2** con conectividad LC y troncales MPO preconectorizados; para los enlaces cortos servidor-conmutador dentro del armario son habituales los latiguillos **DAC** (cobre *twinax* directo, pasivo hasta ~5 m) y **AOC** (ópticos activos). La puesta a tierra de telecomunicaciones y la continuidad de masas de racks, bandejas y pantallas se normaliza en **ANSI/TIA-607**.
...
| Estándar | Año | Tipo | Clases | Potencia del equipo alimentador (PSE) | Potencia al dispositivo (PD) |
| --- | --- | --- | --- | --- | --- |
| IEEE **802.3af** (PoE) | 2003 | 1 | 0-3 | **15,4 W** | 13 W |
| IEEE **802.3at** (PoE+) | 2009 | 2 | 4 | **30 W** | 25,5 W |
| IEEE **802.3bt** (4PPoE) | 2018 | 3 / 4 | 5-6 / 7-8 | **60 / 90 W** | 51 / 71,3 W |

Antes de alimentar, el PSE detecta el PD por su firma de resistencia de **25 kΩ** y negocia la clase de potencia por hardware o, con más granularidad, por **LLDP**. El 802.3bt alimenta por los **cuatro pares** y exige atención al calentamiento de los mazos de cables y al desequilibrio de resistencia DC; con cargas PoE altas se recomienda cableado de categoría 6A y limitar el tamaño de los mazos.
...
- **Categoría**: **6A / clase EA** (10GBASE-T hasta 100 m), el mínimo razonable en obra nueva con 15-25 años de vida útil; en mazos densos con PoE conviene cable **apantallado (F/UTP)**, que elimina el problema de la diafonía exógena y disipa mejor el calor. Cubierta **LSZH** con la euroclase **CPR** que fije el pliego para un edificio de pública concurrencia.
...
- **Puesta a tierra**: sistema de tierra de telecomunicaciones y continuidad de pantallas (*bonding*) en toda la instalación apantallada, conforme a **ANSI/TIA-607**.
...
- **PoE**: teléfonos IP y cámaras con **802.3af** (15,4 W); AP Wi-Fi 6/6E con **802.3at** (30 W) o **802.3bt** los de gama alta (tema [76](76-redes-inalambricas-y-5g.md)), en puertos **2.5/5GBASE-T (802.3bz)** para no limitar el AP a 1 Gbps. Se comprueba el **presupuesto PoE** de cada conmutador (por ejemplo, 740 W) frente a la suma de cargas, y el SAI del armario se dimensiona incluyendo ese consumo.
...
- ANSI/TIA-568: TIA-568.0-E/568.1-E y **ANSI/TIA-568.2-E** (cableado de par trenzado, octubre de 2024); ANSI/TIA-606 (administración), ANSI/TIA-607 (tierras y continuidad de masas) y ANSI/TIA-942 (CPD), citadas por edición (normas de pago).
- Serie ISO/IEC 11801 (partes 1 a 6; **ISO/IEC 11801-1:2017**, *Generic cabling for customer premises*) y serie europea EN 50173; EN 50174-2 (instalación).
- IEEE 802.3af-2003, 802.3at-2009 y 802.3bt-2018 (Power over Ethernet); IEEE 802.3bz-2016 (2.5G/5GBASE-T).
- Reglamento (UE) 305/2011 de productos de construcción (CPR), aplicable a los cables desde el 1 de julio de 2017, y EN 50575 (reacción al fuego de cables).
