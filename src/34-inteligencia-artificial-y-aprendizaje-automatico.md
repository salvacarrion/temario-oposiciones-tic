...
- **Aprendizaje Supervisado (Supervised)**: Los algoritmos se entrenan con datos etiquetados. Por ejemplo, un modelo que clasifica correos electrónicos como "spam" o "no spam" basándose en ejemplos preclasificados.
