...
- **Art. 3-7, 9: Nombramiento, publicación, posesión, juramento, incompatibilidades y responsabilidades**:
    ...
    - Empieza a ejercer a partir de la publicación en el BOE.
    - **Jurará la Constitución y el Estatuto de Autonomía** en las primeras Corts
...
- **Art. 10: Funciones del President**:
    ...
    - Mantiene relaciones con otras instituciones del Estado
...
- **Art. 23: Sesiones del Consell**:
    - Carácter reservado. Solo se hará público el contenido de los acuerdos adoptados.
...
- **Art. 42: Iniciativa legislativa del Consell**:
    ...
    - **Proceso de elaboración de proyectos de ley**:
        - **Anteproyecto de Ley**:
            - Elaborado por la **Consellería correspondiente**.
            - Acompañado de:
                - Estudios e informes justificativos de su necesidad y oportunidad.
                - **Memoria técnica** sobre los costes previstos.
            - Se somete a:
                - Informe del Subsecretario del departamento.
                - Informe de la **Abogacía General de la Generalitat**.
        - **Remisión al Consell**:
            - El Conseller eleva el anteproyecto al Consell.
            - El Consell revisa y, si procede, lo aprueba como **proyecto de ley**.
        - **Remisión a Les Corts**:
            - Una vez aprobado, se remite a Les Corts para su debate y tramitación legislativa.
...
- **Art. 67: Órganos Superiores**:
    - **Conseller:** Responsable de la dirección política del Departamento.
    - **Secretarios Autonómicos:** Dependientes del President, Vicepresidentes o Consellers.
- **Art. 68: Secretarías Autonómicas [Órgano superior]**:
    - Se encarga de dirigir y coordinar los centros directivos bajo su dependencia, resolver recursos administrativos que no agoten la vía administrativa, e impulsar la consecución de programas asignados.
- **Art. 69: Subsecretarías [nivel directivo]**:
...
- **Art. 70: Directores Generales [nivel directivo]**:
    - Dirigen y gestionan servicios, supervisan dependencias y elaboran informes anuales.
- **Art. 71: Unidades Administrativas [nivel administrativo]**:
...
- **Art. 72: Organización del Nivel Administrativo**:
    - **Compuesto por**: Subdirecciones generales, servicios, secciones, unidades y negociados.
- **Art. 73: Secretaría General Administrativa**:
